...
class ForumCategoryForm extends Form
{
     ...
     * 
     * @access public
     * @param ForumCategory $entity
     * @param array $options
     * @return void
     */
    public function initialize(ForumCategory $entity = null, array $options = [])
    {
        ...
        $title->addValidators([
            ...
            new UniqueObject([
                ...
                'object_repository' => $this->getEntityManager()->getRepository(ForumCategory::class),
                'fields' => [ 'title', 'parent' ],
                'messages' => [
    ...
    {
        $rows = $this->getEntityManager()->getRepository(ForumCategory::class)->getParentsList();
