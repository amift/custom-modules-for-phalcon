...
class AddVideoArticleMemberForm extends Form
{
    ...
    public function initialize(Article $entity = null, array $options = [])
    {
        ...
        // Video
        $video = new Text('video', [ 'placeholder' => 'http://', 'tabindex' => '15' ]);
        $video->addValidators([
            $validatorRequired,
            $validatorMaxStringLength,
            new Url([
            ...
            new UniqueObject([
                ...
                'fields' => [ 'video' ],
                'messages' => [
                    UniqueObject::ERROR_OBJECT_NOT_UNIQUE => $this->getTranslator()->trans('error_article_video_exists', 'Ziņa ar norādīto video materiālu jau eksistē'),
                ],
            ])
        ]);
        $this->add($video);
        ...
        // Summary
        $summary = new TextArea('summary', [ 'class' => 'textarea-md', 'tabindex' => '16' ]);
        ...
        // Source URL
        $sourceUrl = new Text('sourceUrl', [ 'placeholder' => 'http://', 'tabindex' => '17' ]);
